...
public class PlsqlException extends CancellationException {
  ...
  public PlsqlException(Recognizer<?,?> recognizer, int line, int column, Token symbol, String description) {
